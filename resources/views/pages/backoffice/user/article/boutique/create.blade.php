...
<div class="box-user-t">
    <h3 style="font-size: 18px">{{$boutique->name}} - Vendez votre article</h3>
    <div class="row w-100 m-auto">
        <div class="col-12 col-md-6 col-lg-9 p-0">
            <form action="{{route('boutique.article.store',$boutique->slug)}}" method="POST" class="w-100" id="create-form" enctype="multipart/form-data">
                @csrf
