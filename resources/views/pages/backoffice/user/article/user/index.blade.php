        ...
        <div class="head-list">
            <div class="box-list-title pt-4 pl-2 pr-2 w-100">
                <div class="d-md-block d-lg-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{route('user.article.create')}}" class="btn btn-primary mb-2 mb-md-0" style="color: #fff"><i class="ti ti-plus"></i> Deposer une annonce</a>
                ...
                @if ($articles->count() > 0)   
                    ...
                    <div class="box-list-items w-100 pl-3 pr-3"  style="color: black; border-bottom: 0.3px solid rgba(0, 0, 0, 0.123)">
                        <div class="row p-2 w-100 m-auto">
                            ...
                            <div class="col-2 p-0 text-center responsive-col">
                                <a href="{{route('user.article.show', $item->slug)}}" class="btn btn-primary mb-2" style="color: #fff"><i class="ti ti-eye"></i></a>
                                <a href="{{route('user.article.edit', $item->slug)}}" class="btn btn-light mb-2"><i class="far fa-edit"></i></a>
                                @if (authUser()->boutiques->count() > 0)
                                    <a href="#" class="btn btn-light mb-2"  data-toggle="modal" data-target="#staticBackdrop{{$i}}"><i class="fas fa-exchange-alt"></i></a>
                                    ...
                                    <div class="modal fade" id="staticBackdrop{{$i}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdrop{{$i}}Label" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <h5 class="modal-title text-left" id="staticBackdropLabel">Transférer l'article<br>{{$item->name}}</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>
                                            <form action="{{route('user.article.transferUpdate',$item->slug)}}" method="POST" id="transfer-form{{$i}}">
                                                @csrf
                                                @method('PATCH')
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    document.getElementById('transfer-form{{$i}}').submit();">Transférer</button>
                                                </div>
                                            </form>
                                        </div>
                                        </div>
                            ...
                            <div class="box-list-items w-100 pl-3 pr-3">
                                <div class="row p-2 w-100 m-auto" style="color: black; border-bottom: 0.3px solid rgba(0, 0, 0, 0.123)">
                                    ...
                                    <div class="col-2 p-0 text-center responsive-col">
                                        <a href="{{route('user.article.show', $item->slug)}}" class="btn btn-primary mb-2" style="color: #fff"><i class="ti ti-eye"></i></a>
                                        <a href="{{route('user.article.edit', $item->slug)}}" class="btn btn-light mb-2"><i class="far fa-edit"></i></a>
                                        <a href="{{route('user.article.online', $item->slug)}}" class="btn btn-light mb-2"><i class="fas fa-bullhorn"></i></a>
